  ...
  return (
    <div>
        <div className='flex flex-col gap-6 p-28 px-5 max-w-6xl mx-auto'>
          ...
          <Link to='/search' className='text-md sm:text-sm text-teal-500 font-bold hover:underline hover:text-teal-600 flex items-center gap-1'><span>View all posts </span>
          <HiArrowNarrowRight/>
          </Link>
        </div>
